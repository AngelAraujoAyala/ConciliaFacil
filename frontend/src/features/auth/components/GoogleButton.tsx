    ...
    return (
        <div className="w-full">
            ...
            <button
                ...
                disabled={isPending}
                className="w-full flex justify-center items-center gap-3 rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-xs font-semibold text-slate-200 shadow-sm transition-all hover:bg-white/10 hover:border-white/20 focus:outline-none disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
            >
                {isPending ? (
            ...
            <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-[10px]">
                    <span className="bg-slate-900/90 px-3 text-slate-500 uppercase font-semibold tracking-wider">
